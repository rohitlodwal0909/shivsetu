...
import { FaHeart, FaShoppingCart, FaEye, FaStar, FaTrophy } from 'react-icons/fa';
...
const BestSellers = () => {
    ...
    // Select first 4 products for Best Sellers
            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="mb-8 lg:mb-16 pl-1 text-left">
                    <h2 className="text-3xl md:text-3xl font-bold text-gray-900 leading-tight flex items-center gap-2">
                        {isHindi ? "सबसे ज्यादा बिकने वाले" : "Best Sellers"} <span className="text-2xl md:text-3xl">🏆</span>
                    </h2>
                    <p className="text-sm md:text-base text-gray-500 mt-1.5 font-medium">
                        {isHindi ? "हमारे भक्तों द्वारा " : "Most loved by our "}
                        <span className="text-[#e14503]">{isHindi ? "सबसे पसंदीदा" : "Devotees"}</span>
                    </p>
                </div>
