...
const MobileTourCard = ({ id, banner_image, package_name, cities, duration_days, price, rating }) => {
    ...
    return (
        ...
        >
            <div className="relative h-64 w-full">
                <SafeImage src={banner_image} type={"packages/"} alt={package_name} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
