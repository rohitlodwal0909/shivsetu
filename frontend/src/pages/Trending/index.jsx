  ...
  ...category.map((cat) => ({
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            {/* Header */}
            <PageHeader
                title={isHindi ? 'ट्रेंडिंग अब' : 'Trending Now'}
                subtitle={isHindi ? 'देखें कि अभी क्या हर कोई खरीद रहा है' : 'See what everyone is buying right now'}
                breadcrumb={[{ label: isHindi ? 'ट्रेंडिंग' : 'Trending', link: "/trending" }]}
            />
