...
const BestSeller = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            {/* Header */}
            <PageHeader
                title={isHindi ? 'सबसे ज्यादा बिकने वाला' : 'Best Sellers'}
                subtitle={isHindi ? 'ग्राहकों द्वारा पसंद किए जाने वाले हमारे सबसे लोकप्रिय उत्पाद' : 'Our most popular products loved by customers'}
                breadcrumb={[{ label: isHindi ? 'बेस्ट सेलर' : 'Best Seller', link: "/best-seller" }]}
            />
